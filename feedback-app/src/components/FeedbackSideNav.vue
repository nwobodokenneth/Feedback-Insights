<template>
  <div class="card overflow-y-hidden overflow-x-hidden">
      <div class="hidden focus:outline-none sm:flex justify-start p-6 text-blue-700 items-center space-x-3 w-full mb-6">
        ...
        <h2 class="text-2xl leading-6 font-bold">LOGO</h2>
      </div>
      <div class="mt-4 flex flex-col justify-start items-center w-full">
        <button class="focus:outline-none focus:text-blue-500 flex justify-start hover:text-blue-500 rounded py-4 items-center space-x-2 w-full px-4">
          ...
          <p class="text-sm leading-4 border-b border-transparent hover:border-white focus:border-white">Dashboard</p>

        </button>
        <button class="focus:outline-none focus:text-blue-500 flex justify-start hover:text-blue-500 rounded py-4 items-center space-x-2 w-full px-4" ref="menu_item">
          ...
          <p class="text-sm leading-4 border-b border-transparent hover:border-white focus:border-white break-all text-left">Feedback Insights</p>
        ...
        <button class="focus:outline-none focus:text-blue-500 flex justify-start hover:text-blue-500 rounded py-4 items-center space-x-2 w-full px-4">
          ...
          <p class="text-sm leading-4 border-b border-transparent hover:border-white focus:border-white break-words text-left">Products & Assets Library</p>
        ...
        <button class="focus:outline-none focus:text-blue-500 flex justify-start hover:text-blue-500 rounded py-4 items-center space-x-2 w-full px-4">
          ...
          <p class="text-sm leading-4 border-b border-transparent hover:border-white focus:border-white break-words text-left">Feedback Collection Setting</p>
        </button>
        <div class="my-2 w-full">
          <hr class=" w-full" />
        </div>
        <button class="focus:outline-none focus:text-blue-500 flex justify-start hover:text-blue-500 rounded py-4 items-center space-x-2 w-full px-4">
          ...
          <p class="text-sm leading-4 border-b border-transparent hover:border-white focus:border-white break-words text-left">Automated Campaigns</p>
        ...
        <button class="focus:outline-none focus:text-blue-500 flex justify-start hover:text-blue-500 rounded py-4 items-center space-x-2 w-full px-4">
          ...
          <p class="text-sm leading-4 border-b border-transparent hover:border-white focus:border-white">E-CRM</p>
        ...
        <button class="focus:outline-none focus:text-blue-500 flex justify-start hover:text-blue-500 rounded py-4 items-center space-x-2 w-full px-4">
          ...
          <p class="text-sm leading-4 border-b border-transparent hover:border-white focus:border-white">Templates</p>
        ...
        <button class="focus:outline-none focus:text-blue-500 flex justify-start hover:text-blue-500 rounded py-4 items-center space-x-2 w-full px-4">
          ...
          <p class="text-sm leading-4 border-b border-transparent hover:border-white focus:border-white break-all text-left">Resources & Info</p>
        </button>
        </div>
  </div>
</template>
